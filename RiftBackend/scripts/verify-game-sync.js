...
async function verifyGameSync() {
    ...
    const client1 = (0, socket_io_client_1.io)(SOCKET_URL, { auth: { token: TOKEN_1 } });
    const client2 = (0, socket_io_client_1.io)(SOCKET_URL, { auth: { token: TOKEN_2 } });
    ...
    const shootPromise = new Promise((resolve, reject) => {
    ...
    const damagePromise = new Promise((resolve, reject) => {
...
//# sourceMappingURL=verify-game-sync.js.map